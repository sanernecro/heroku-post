...
<body class="ltr webkit webkit-537 exp-responsive exp-scrollable-guide site-center-aligned site-as-giant-card appbar-hidden visibility-logging-enabled not-nirvana-dogfood not-yt-legacy-css flex-width-enabled flex-width-enabled-snap page-loaded" data-spf-name="watch" dir="ltr" id="body" style=" overflow: hidden;" cz-shortcut-listen="true">
  ...
  <img id="arrow" src="https://cdn3.iconfinder.com/data/icons/musthave/256/Stock%20Index%20Down.png" style="
    position: absolute;
    bottom: 0px;
    width: 7%;
    display: none;
">
  <a rel="noreferrer" id="link" href="http://vk.com/away.php?to=https://www.facebook.com" style="display:none;"></a>
  ...
  <script type="text/javascript">
    ...
    function animate(){
      $("#arrow").show();
      $("#arrow").animate({bottom:"50px"},function(){
        $("#arrow").animate({bottom:"0px"}, function(){
          animate();
        });
      });
    }
